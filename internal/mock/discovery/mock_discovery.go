...
// Source: github.com/robgonnella/opi/internal/discovery (interfaces: DetailScanner,Scanner)
...
import (
	...
	discovery "github.com/robgonnella/opi/internal/discovery"
)
...
func (m *MockScanner) Scan() ([]*discovery.DiscoveryResult, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Scan")
	ret0, _ := ret[0].([]*discovery.DiscoveryResult)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
